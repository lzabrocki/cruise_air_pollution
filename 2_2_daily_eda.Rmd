...
To reproduce exactly the `2_daily_eda.html` document, we first need to have installed:

* the [R](https://www.r-project.org/) programming language on your computer 
* [RStudio](https://rstudio.com/), an integrated development environment for R, which will allow you to knit the `2_daily_eda.Rmd` file and interact with the R code chunks
...
```{r, fig.width=25, fig.height=10, layout="l-body-outset", code_folding="Please show me the code!"}
...
```{r, layout="l-body-outset", fig.width=25, fig.height=10, code_folding="Please show me the code!"}
