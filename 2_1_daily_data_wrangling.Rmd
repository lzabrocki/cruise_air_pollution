...
We to load the following packages:
...
* `r round(mean(port_data$ferry_boat)*100,1)`% of boats are ferries
* `r round(mean(port_data$cruise_boat)*100,1)`% of boats are cruise boats
* `r round(mean(port_data$other_types)*100,1)`% of boats are of other types
