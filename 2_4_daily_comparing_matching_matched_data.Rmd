...
To reproduce exactly the `2_daily_comparing_matching_matched_data.html` document, we first need to have installed:

* the [R](https://www.r-project.org/) programming language 
* [RStudio](https://rstudio.com/), an integrated development environment for R, which will allow you to knit the `2_daily_comparing_matching_matched_data.Rmd` file and interact with the R code chunks
